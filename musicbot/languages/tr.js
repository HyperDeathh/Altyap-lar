const language = {
    ...
    message1: "❌ Rica etsem bir ses kanalına bağlandıktan sonra kullanırmısınız.",
    message2: "❌ Malesef benimle farklı kanaldasın.",
    message3: "Yetkin yetersiz",
    msg4: "Bir şeyler ters gitti",
    msg5: "❌ Şuan bir müzik oynatılmıyor.",
    msg6: "Müziği Kaydet",
    msg7: "Playlist adını yaz.",
    msg8: "Bu şarkı canlı yayın, görüntülenecek süre verisi yok.",
    msg9: "**✅ Başarılı:** veriler güncellendi.",
    msg10: "❌ Bu isime sahip bir playlistiniz yok. Tekrar kontrol edermisiniz?",
    msg11: "❌ Bu müzik zaten listende var. Tekrar eklemedim.",
    ...
    msg14: "✅ Sırada hiç şarkı kalmadı. /play daha fazla müzik çalabilirsin. Ben çıktım.",
    msg15: "❌ Kanalımda kimse kalmadı çıkıyorum ben :(",
    ...
    msg85: `Müzik kapatıldı. Tekrar oynatmak için /play. Ben çıktım`,
    msg86: "Güncelle",
